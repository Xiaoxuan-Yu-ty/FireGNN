...
def main():
    ...
    parser.add_argument('--dataset', type=str, nargs='+',
                        default=['NormSubgraph', 'NormExpression','NormExpressionSubgraph','Composite', 'NormCluster'],
                       ...
                       help='Dataset to use')
    parser.add_argument('--k', type=int, default=30, help='Number of clusters in K-NN')
