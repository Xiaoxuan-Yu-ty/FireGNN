...
def objective( trial: optuna.trial.Trial, data: HeteroData, train_edges: Dict[Tuple[str, str, str], torch.Tensor], val_edges: Dict[Tuple[str, str, str], torch.Tensor], num_nodes_dict: Dict[str, int], device: torch.device, output_dir: str, k: int, max_epochs: int, patience: int, eval_negatives: int, eval_pos_cap: Optional[int], ) -> float: 
